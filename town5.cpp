...
int shengming=1000,shanghai=50,fangyu=20,jinbi=200,jingyan=100,shengmingf=999999999;//主角资料
...
void ziliao()
{
	cout<<"BUG小怪:此怪在打小怪时有可能会出现并化身为二级增强5级小怪,并且超进化"<<endl;
	cout<<"小镇5.0现行欢迎你!!!"<<endl;
	system("pause");
}
void tanbao()
{
