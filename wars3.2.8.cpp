...
#include<ctime>
using namespace std;
int e,g=50,o1=3000,o2,e1=3000,e2,s,l,sl,pj,dd,i,ts,k,tk,tke,tkk,xx,bt,gs,fj,fje,fk,jg,jk,hd,hde,jd,jde,zx,iii,pz,lzpz,pze,lzpze;
char d,ch;
string ssss;
void xs(char ccc){
	cout<<"金币数："<<g<<endl;
...
void aa(string sssss){
	...
	while(o1>0&&e1>0&&(sssss=="16391639"||g<=1000&&o1<=3000)){
		int ttt=o2;
		int fff=e2;
		o1-=e;
		int last_hp=o1;
...
//	if(g>10000||o1>10000) bg();
	...
	Sleep(1500);
	system("cls");
	cout<<"若有bug及新想法,请发电子邮件至conio_h@163.com\n";
	cout<<"Goodbye!\n";
	system("pause"); 
	return;
}
